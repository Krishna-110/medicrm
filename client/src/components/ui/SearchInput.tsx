  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <input
        ...
        className="w-full pl-10 pr-4 py-2.5 bg-white border border-ink-200 rounded-xl text-base sm:text-sm text-ink-900 placeholder:text-ink-400 focus:outline-none focus:border-primary-400 focus:ring-[3px] focus:ring-primary-500/15 transition-all shadow-sm"
      />
    </div>
  )
}
