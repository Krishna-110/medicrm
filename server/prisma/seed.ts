...
const PRODUCTS: [sku: string, generic: string, brand: string, form: string, price: number, stock: number][] = [
  ...
  ['MED-101', 'Tejasvi Ark', 'Tejasvi Ark', 'other', 450, 60],
  ['MED-102', 'Tejasvi Kadha', 'Tejasvi Kadha', 'other', 380, 60],
  ['MED-103', 'Vedic Shiv Amrit Ark', 'Vedic Shiv Amrit Ark', 'other', 620, 40],
  ['MED-104', 'Vedic Shiv Amrit Syrup', 'Vedic Shiv Amrit Syrup', 'syrup', 340, 50],
  ['MED-105', 'Anus Care 1', 'Anus Care 1', 'other', 290, 45],
  ['MED-106', 'Anus Care 2', 'Anus Care 2', 'other', 290, 45],
  ['MED-107', 'Anus Care Cream', 'Anus Care Cream', 'other', 210, 70],
  ['MED-108', 'Kamaking Capsule', 'Kamaking Capsule', 'capsule', 750, 35],
  ['MED-109', 'Kamaking Oil', 'Kamaking Oil', 'other', 560, 40],
  ['MED-110', 'Asthma Powder', 'Asthma Powder', 'other', 320, 55],
  ['MED-111', 'Asthma Tab', 'Asthma Tab', 'tablet', 180, 80],
  ['MED-112', 'Ashwashila Malt', 'Ashwashila Malt', 'other', 890, 25],
  ['MED-113', 'Weight Gain Powder', 'Weight Gain Powder', 'other', 640, 40],
  ['MED-114', 'Weight Loss Powder', 'Weight Loss Powder', 'other', 640, 40],
  ['MED-115', 'Kidney Kaya Syrup', 'Kidney Kaya Syrup', 'syrup', 410, 50],
  ['MED-116', 'Lady Gold Ark', 'Lady Gold Ark', 'other', 520, 45],
  ['MED-117', 'Sansamrit', 'Sansamrit', 'other', 470, 50],
  ['MED-118', 'Dardantak Powder', 'Dardantak Powder', 'other', 260, 65],
];
